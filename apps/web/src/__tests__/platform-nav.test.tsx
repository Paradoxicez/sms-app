/**
 * VALIDATION: TBD-07 — D-04 platform sidebar = exactly 6 items
 */
...
describe("PlatformNav (D-04, D-06)", () => {
  it("renders exactly 6 items: Organizations, Packages, Cluster Nodes, SRS Engine, Platform Audit, Users", () => {
    render(<PlatformNav />);
    const expected = [
      "Organizations",
      "Packages",
    ...
    // Exactly six navigation links, no tenant items bleed in.
