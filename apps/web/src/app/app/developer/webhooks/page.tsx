...
import SourcePage from "@/components/pages/tenant-developer-webhooks-page";
...
export default function Page() {
  ...
  if (!isEnabled("webhooks")) return <FeatureGateEmptyState featureName="Webhooks" featureSlug="webhooks" />;
  return <SourcePage />;
}
