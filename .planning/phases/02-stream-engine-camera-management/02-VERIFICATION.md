...
1. Socket.IO orgId is hardcoded to 'default' in the frontend -- will need to be wired to auth session for multi-tenant correctness
2. CAM-07 should be marked as Complete in REQUIREMENTS.md traceability table
