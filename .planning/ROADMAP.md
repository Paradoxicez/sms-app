...
**Plans:** 6 plans
Plans:
- [ ] 23-01-PLAN.md — DEBT-05 (partial): Squash hand-rolled SQL into single 0_init migration; replace db:push with db:reset; add db:check-drift; update CLAUDE.md (Wave 1)
...
- [ ] 23-06-PLAN.md — DEBT-05 (completion): Update setup-test-db.sh to use prisma migrate deploy; BLOCKING checkpoint verifies cold-deploy + drift exit 0; delete 8 hand-rolled migration directories + 2 standalone RLS files (Wave 2, has user checkpoint)
