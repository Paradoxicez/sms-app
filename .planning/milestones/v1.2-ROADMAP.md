...
- [x] 22-05-PLAN.md — Distinct-tags endpoint GET /cameras/tags/distinct + Redis cache (60s TTL) with in-memory fallback (D-09, D-28)
- [x] 22-06-PLAN.md — Bulk tag endpoint POST /cameras/bulk/tags (Add/Remove) + per-camera audit row + cache invalidation (D-11..D-13, D-26)
- [x] 22-07-PLAN.md — TagInputCombobox composite (chip + autocomplete) + camera-form-dialog integration (D-08, D-09)
